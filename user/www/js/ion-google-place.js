        ...
        function($ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document) {
            return {
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    var POPUP_TPL = [
                        '<div class="ion-google-place-container modal animated">',
                    ...
                    popupPromise.then(function(el){
                        ...
                        scope.selectLocation = function(location){
                            ...
                            ngModel.$render();
                            el.element.css('display', 'none').removeClass('fadeInRight');
                        ...
                        var onClick = function(e){
                            ...
                            el.element.css('display', 'block').addClass('fadeInRight');
